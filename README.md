...
| Tests | 199 Rego unit tests · 36 integration tests · 32 integrity checks · hash-chain verification per run |
...
python3 tests/test_integrity_regression.py --fail-on medium   # 32 credibility checks
