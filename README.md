...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19917414.svg)](https://doi.org/10.5281/zenodo.19917414)
...
├── README.md
├── docs/
│   ├── appendix/               # Anhang F: rule-to-test mapping (auto-generated by tools/extract_rule_test_mapping.py)
│   ├── architecture/           # Architecture diagrams (Five-Pillar, Gate Flow, Pipeline)
│   ├── reports/                # Phase reports (Phase 11/12), Integrity Fix Report
...
| **Anhang F (Rule-to-Test-Mapping)** | done | Auto-generiert via `tools/extract_rule_test_mapping.py` → `docs/appendix/rule_test_mapping.{json,md}` (10 Policies × Per-Gate-Sektionen) |
...
@software{demir2026genaiopscompliancegates,
  ...
  version      = {v1.0.0},
  date         = {2026-04-30},
  doi          = {10.5281/zenodo.19917414},
  url          = {https://doi.org/10.5281/zenodo.19917414},
