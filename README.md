...
| Tests | 187 Rego unit tests · 35 integration tests · 26 integrity checks · hash-chain verification per run |
...
python3 tests/test_integrity_regression.py --fail-on medium   # 26 credibility checks
